...
import {deleteUserStart, deleteUserSuccess, deleteUserFailure, updateUserStart, updateUserSuccess, updateUserFailure, signOutStart, signOutSuccess, signOutFailure } from '../redux/user/userSlice';
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img onClick={() => fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt={currentUser.name} 
        ...
        className='border p-3 rounded-lg shadow-sm border-gray-300' onChange={handleChange}/>
      ...
      <p className='text-red-700 mt-5'>{showListingError ? "Failed to load listings." : ''}</p>

...
export default function CreateListing() {
  ...
  const handleSubmit = async (e) =>{
    ...
    try {
        ...
        if (+formData.discountedPrice >= +formData.regularPrice) return setError('Discounted price must be less than regular price.');
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                <input type="text" placeholder='Name' className='border p-3 rounded-lg shadow-sm border-gray-300'
                id="name" maxLength='62' minLength='10' required onChange={handleChange} value={formData.name}/>
                <textarea type="text" placeholder='Description' className='border p-3 rounded-lg shadow-sm border-gray-300'
                id="description" required onChange={handleChange} value={formData.description}/>
                <input type="text" placeholder='Address' className='border p-3 rounded-lg shadow-sm border-gray-300'
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex  gap-4">
                    <input onChange={(e)=>setFiles(e.target.files)} className="
                            block w-full cursor-pointer
                            rounded-lg border border-gray-300 bg-gray-50 p-1.5 text-gray-700
                            file:bg-indigo-600 file:text-white file:py-1 file:px-4
                            file:rounded-md file:border-0 file:cursor-pointer file:font-semibold
